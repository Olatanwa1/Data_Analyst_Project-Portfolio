...
-- Q11) Extract top 3 highest sum of score for each device id and the corresponding player_id
SELECT P_id, Dev_id,
SUM(Score) AS Total_Score
FROM Level_details LIMIT 3;
-- Q12) Find players who scored more than 50% of the avg score scored by sum of 
...
-- Q13) Create a stored procedure to find top n headshots_count based on each dev_id and Rank them in increasing order
-- using Row_Number. Display difficulty as well.
